                ...
                <div class="modal-dialog">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="" name="FROMname" value="Frederick Calderon">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="" name="FROMemail" value="fekj97@gmail.com">
                            </div>
                        </div>
