...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="src/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
...
<?php
      include "views/components_dashboard/main_header.php";
      include "views/components_dashboard/main_sidebar.php";
      include "views/components_dashboard/content_wrapper.php";
      include "views/components_dashboard/main_footer.php";
?>
...
<!-- jQuery UI 1.11.4 -->
<script src="src/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="src/bower_components/raphael/raphael.min.js"></script>
<script src="src/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="src/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
